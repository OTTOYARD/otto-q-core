...
require GREEN): **L-22, L-23, L-24, L-25, L-41, L-42, L-52**, then the `orchestrate.py` cluster **L-43, L-44, L-57**, then the `signals.py` cluster **L-14, L-15, L-16, L-17, L-46, L-47, L-48**, then **L-18** and **L-21** in the lexicographic chain, then the `learn.py` cluster **L-10, L-11, L-12, L-45**, then **L-38, L-55, L-56** in the intent artifact and resolver, and **L-33, L-34, L-54** in ottoq-intelligence's priors. Sixty-eight mutations across the twenty-nine,
all caught. Two of them needed the database, not just the file — the frame did not carry the
...
**Coverage is now 65 of 87.**

Two things this cluster found that were not in any finding. Composing the connector into the
