# Round 16 canons — 2026-09-04 (fired 8:39–10:05 PM CT)

Flagship depot, pinned sim start `2026-09-01 02:00:00+00`, proposer quiesced.
Engine as of **0196** (applied 8:37 PM CT). Seven pairs: busy_day/171717/12t
twice. **Seven of seven passed** — the first all-green round since round 13.

> Written 2026-09-06 from the verdict rows (see round14.md). Retro columns computed
> with 0199's hash functions.

| scenario | seed | ticks | h_cmd | h_dec | h_bkg | h_nrg | vs r15 |
|---|---|---|---|---|---|---|---|
| busy_day | 171717 | 12 | `80183641` | `6e116d5b` | `b1d72a62` | `625014b7` | identical (2 pairs, both) |
| busy_day | 314159 | 12 | `cf74d080` | `1788ee1c` | `eaff0912` | `4afd1004` | passed; equals r14/r15 arm A |
...
One boot fingerprint for every arm in the round (`e06b403e`), and it has not
changed since. `h_evt` moved on three columns and `endst` on all six between round
15 and 16 while `h_cmd`/`h_bkg` did not: 0196 (two flags that die with the
transaction) changed what the world looks like at the end, not what was decided.
