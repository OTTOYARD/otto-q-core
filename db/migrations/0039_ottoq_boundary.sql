...
--
-- Replaces 12 direct world-state writes in ottoq_decide_tick
-- with ottoq_vehicle_commands emission.
-- 4 writes already emitted commands (wash/service/departure) — those UPDATEs removed.
-- 8 writes did NOT emit commands — now INSERT commands instead.
--
-- The twin's ottoq_sim_confirm_commands (migration 0036) validates and executes.
-- Apply with: psql -f db/migrations/0039_ottoq_boundary.sql
