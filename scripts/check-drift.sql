...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, 'a_worse_ranked_proposer_removes_a_better_one_from_the_pool_before_rank_is_read'::text, '0362_a_worse_ranked_proposer_removes_a_better_one_from_the_pool_before_rank_is_read.sql'::text)
