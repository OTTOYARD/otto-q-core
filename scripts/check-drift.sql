...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, 'a_quarter_of_departures_skipped_the_readiness_check_because_it_runs_before_the_vehicle_is_staged'::text, '0431_a_quarter_of_departures_skipped_the_readiness_check_because_it_runs_before_the_vehicle_is_staged.sql'::text)
