...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0302_the_only_agent_that_tunes_dials_is_the_one_that_bypasses_the_catalog'::text, '0302_the_only_agent_that_tunes_dials_is_the_one_that_bypasses_the_catalog.sql'::text)
