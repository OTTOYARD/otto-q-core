...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('20260926112238'::text, 'a_car_moved_off_a_faulted_charger_was_staged_with_no_step_so_no_gate_read_it'::text, '0474_a_car_moved_off_a_faulted_charger_was_staged_with_no_step_so_no_gate_read_it.sql'::text),
    ...
    ('20260926160930'::text, 'the_wave_admission_edge_function_stops_moving_cars_under_the_live_tick'::text, '0488_the_wave_admission_edge_function_stops_moving_cars_under_the_live_tick.sql'::text),
