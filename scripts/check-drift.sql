...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0267_the_fire_log_registered_a_stamp_and_never_bound_it_to_a_run'::text, '0267_the_fire_log_registered_a_stamp_and_never_bound_it_to_a_run.sql'::text)
