...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0269_the_purge_cannot_see_a_scheduled_round_only_a_running_pair'::text, '0269_the_purge_cannot_see_a_scheduled_round_only_a_running_pair.sql'::text)
