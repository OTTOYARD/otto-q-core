...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0300_three_dials_whose_floor_is_on_the_other_side_of_the_assignment'::text, '0300_three_dials_whose_floor_is_on_the_other_side_of_the_assignment.sql'::text)
