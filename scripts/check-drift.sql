...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, 'the_probe_for_the_one_unprobed_context_the_engine_actually_exercises_built_and_proven_but_not_wired'::text, '0418_the_probe_for_the_one_unprobed_context_the_engine_actually_exercises_built_and_proven_but_not_wired.sql'::text),
    ('PENDING'::text, 'my_own_abstention_counter_counted_two_of_the_four_abstentions_as_real_verdicts'::text, '0419_my_own_abstention_counter_counted_two_of_the_four_abstentions_as_real_verdicts.sql'::text)
