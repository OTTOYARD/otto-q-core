...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('202608090455'::text, 'stop_is_two_phase_so_a_run_can_always_be_stopped'::text, '0017_stop_is_two_phase_so_a_run_can_always_be_stopped.sql'::text),
    ...
    ('20260809220000'::text, 'run_governor_auto_stop'::text, '0025_run_governor_auto_stop.sql'::text),
    ...
    ('20260810171310'::text, 'revert_0005_condition_resets_part2'::text, '0034_revert_0005_condition_resets_part2.sql'::text),
    ...
    ('20260819031500'::text, 'schema_v2_service_objects'::text, '0043_schema_v2_service_objects.sql'::text),
    ('20260819054500'::text, 'canonical_kpis'::text, '0044_canonical_kpis.sql'::text),
    ('20260819180000'::text, 'twin_determinism_and_playback'::text, '0045_twin_determinism_and_playback.sql'::text),
    ('20260819200000'::text, 'site_alpha_pack_classes'::text, '0046_site_alpha_pack_classes.sql'::text),
    ('20260819210000'::text, 'twin_determinism_charge_session_salts'::text, '0047_twin_determinism_charge_session_salts.sql'::text),
    ('20260819220000'::text, 'twin_service_flow_admit_order_and_deal_salts'::text, '0048_twin_service_flow_admit_order_and_deal_salts.sql'::text),
    ('20260819230000'::text, 'twin_arm_refuse_move_clock_domain'::text, '0049_twin_arm_refuse_move_clock_domain.sql'::text),
    ('20260819235000'::text, 'twin_deterministic_cursor_order'::text, '0050_twin_deterministic_cursor_order.sql'::text),
    ('20260820010000'::text, 'twin_assigner_salt_and_tiebreak'::text, '0051_twin_assigner_salt_and_tiebreak.sql'::text),
    ('20260820020000'::text, 'twin_holdout_and_comms_run_relative_salts'::text, '0052_twin_holdout_and_comms_run_relative_salts.sql'::text),
    ('20260820030000'::text, 'benchmark_reset_config_residue'::text, '0053_benchmark_reset_config_residue.sql'::text),
    ('20260820040000'::text, 'run_stable_cursor_order_full_sweep'::text, '0054_run_stable_cursor_order_full_sweep.sql'::text),
    ('20260820050000'::text, 'manifest_run_relative_draw_salt'::text, '0055_manifest_run_relative_draw_salt.sql'::text),
    ('20260820060000'::text, 'cuopt_propose_enabled_cert_quiesce'::text, '0056_cuopt_propose_enabled_cert_quiesce.sql'::text),
    ('20260820070000'::text, 'vehicle_state_trigger_preserve_caller_clock'::text, '0057_vehicle_state_trigger_preserve_caller_clock.sql'::text),
    ('20260820080000'::text, 'variability_card_run_stable_draw_scope'::text, '0058_variability_card_run_stable_draw_scope.sql'::text),
    ('20260820160000'::text, 'refusal_reactor_run_stable_order'::text, '0059_refusal_reactor_run_stable_order.sql'::text),
    ('20260820180000'::text, 'confirm_and_selection_run_stable_order'::text, '0060_confirm_and_selection_run_stable_order.sql'::text),
    ('20260820190000'::text, 'state_stamp_default_is_sim_domain'::text, '0061_state_stamp_default_is_sim_domain.sql'::text),
    ('20260820190000'::text, 'confirm_supersede_total_order'::text, '0062_confirm_supersede_total_order.sql'::text),
    ('20260820210000'::text, 'booking_pick_total_order'::text, '0063_booking_pick_total_order.sql'::text),
    ('20260821010000'::text, 'hold_outlives_its_command'::text, '0064_hold_outlives_its_command.sql'::text),
    ('20260821040000'::text, 'cert_arm_pinned_sim_start'::text, '0065_cert_arm_pinned_sim_start.sql'::text),
    ('20260821050000'::text, 'one_begin_charge_per_enactment'::text, '0066_one_begin_charge_per_enactment.sql'::text),
    ('20260822013000'::text, 'greedy_stall_pick_total_order_and_sim_domain'::text, '0067_greedy_stall_pick_total_order_and_sim_domain.sql'::text),
    ('20260822020000'::text, 'proposer_never_reuses_another_vehicles_hold'::text, '0068_proposer_never_reuses_another_vehicles_hold.sql'::text),
    ('20260822031000'::text, 'cert_arm_finish_releases_tethers'::text, '0069_cert_arm_finish_releases_tethers.sql'::text),
    ('20260823160000'::text, 'cert_arm_start_pins_the_world'::text, '0070_cert_arm_start_pins_the_world.sql'::text),
    ('20260824200500'::text, 'cert_arm_step_raises_on_short_advance'::text, '0071_cert_arm_step_raises_on_short_advance.sql'::text),
    ('20260824201500'::text, 'cert_arm_step_null_safe_run_guard'::text, '0072_cert_arm_step_null_safe_run_guard.sql'::text),
    ('20260827200000'::text, 'provenance_says_what_it_is'::text, '0073_provenance_says_what_it_is.sql'::text),
    ('20260827210000'::text, 'the_archive_carries_its_key'::text, '0074_the_archive_carries_its_key.sql'::text),
    ('20260827230000'::text, 'deploy_decision_idempotency'::text, '0075_deploy_decision_idempotency.sql'::text),
    ('20260827230100'::text, 'command_reason_codes'::text, '0076_command_reason_codes.sql'::text),
    ('20260828030000'::text, 'revert_reason_code_on_commands'::text, '0078_revert_reason_code_on_commands.sql'::text),
    ('20260828040000'::text, 'activity_feed'::text, '0079_activity_feed.sql'::text),
    ('20260828050000'::text, 'charge_first_mutual_exclusion'::text, '0080_charge_first_mutual_exclusion.sql'::text),
    ('20260828070000'::text, 'bay_routing_seats_the_vehicle'::text, '0081_bay_routing_seats_the_vehicle.sql'::text),
    ('20260828080000'::text, 'wash_hours_clock_backstop'::text, '0082_wash_hours_clock_backstop.sql'::text),
    ('20260828090000'::text, 'deep_clean_cabin_condition'::text, '0083_deep_clean_cabin_condition.sql'::text),
    ('20260828100000'::text, 'deep_clean_flag_ordering'::text, '0084_deep_clean_flag_ordering.sql'::text),
    ('20260828110000'::text, 'wash_must_do_flag_reconciliation'::text, '0085_wash_must_do_flag_reconciliation.sql'::text),
    ('20260829170000'::text, 'refusals_carry_their_reason'::text, '0086_refusals_carry_their_reason.sql'::text),
    ('20260829171500'::text, 'no_command_left_dangling'::text, '0087_no_command_left_dangling.sql'::text),
    ('20260829173000'::text, 'occupied_refusals_reach_the_conflict_ledger'::text, '0088_occupied_refusals_reach_the_conflict_ledger.sql'::text),
    ('20260829191500'::text, 'a_leg_closes_with_its_work'::text, '0089_a_leg_closes_with_its_work.sql'::text),
    ('20260829200000'::text, 'cuopt_enactments_carry_their_verb'::text, '0090_cuopt_enactments_carry_their_verb.sql'::text),
    ('20260829204500'::text, 'the_kernel_defends_the_verb'::text, '0091_the_kernel_defends_the_verb.sql'::text),
    ('20260829213000'::text, 'events_carry_their_run'::text, '0092_events_carry_their_run.sql'::text),
    ('20260829220000'::text, 'a_run_leaves_no_plan_residue'::text, '0093_a_run_leaves_no_plan_residue.sql'::text),
    ('20260829223000'::text, 'canonical_means_constant_not_null'::text, '0094_canonical_means_constant_not_null.sql'::text),
    ('20260829230000'::text, 'the_reset_keeps_a_whitelist_not_a_blacklist'::text, '0095_the_reset_keeps_a_whitelist_not_a_blacklist.sql'::text),
    ('20260829233000'::text, 'target_soc_pins_to_the_seeded_constant'::text, '0096_target_soc_pins_to_the_seeded_constant.sql'::text),
    ('20260829234500'::text, 'no_approval_outlives_its_run'::text, '0097_no_approval_outlives_its_run.sql'::text),
    ('20260830000000'::text, 'the_drain_admission_is_not_a_coin_flip'::text, '0098_the_drain_admission_is_not_a_coin_flip.sql'::text),
    ('20260830003000'::text, 'the_latest_need_is_not_a_heap_order'::text, '0099_the_latest_need_is_not_a_heap_order.sql'::text),
    ('20260830010000'::text, 'service_flow_admissions_close_their_order'::text, '0100_service_flow_admissions_close_their_order.sql'::text),
    ('20260830020000'::text, 'natural_completion_finalizes'::text, '0101_natural_completion_finalizes.sql'::text),
    ('20260830023000'::text, 'finalize_at_the_driver_not_mid_world'::text, '0102_finalize_at_the_driver_not_mid_world.sql'::text),
    ('20260830030000'::text, 'the_live_completion_seam'::text, '0103_the_live_completion_seam.sql'::text),
    ('20260830050000'::text, 'the_tech_verdict_is_not_a_coin_from_another_run'::text, '0104_the_tech_verdict_is_not_a_coin_from_another_run.sql'::text),
    ('20260830053000'::text, 'the_cert_run_quiesces_the_llm_proposer'::text, '0105_the_cert_run_quiesces_the_llm_proposer.sql'::text),
    ('20260830060000'::text, 'the_production_brain_stands_off_a_cert_run'::text, '0106_the_production_brain_stands_off_a_cert_run.sql'::text),
    ('20260830070000'::text, 'the_run_draws_its_own_world'::text, '0107_the_run_draws_its_own_world.sql'::text),
    ('20260830080000'::text, 'the_atom_admission_closes_its_order'::text, '0108_the_atom_admission_closes_its_order.sql'::text),
    ('20260830090000'::text, 'the_watermark_does_not_outlive_its_run'::text, '0109_the_watermark_does_not_outlive_its_run.sql'::text),
    ('20260830100000'::text, 'the_one_command_determinism_check'::text, '0110_the_one_command_determinism_check.sql'::text),
    ('20260830110000'::text, 'the_production_session_lifecycle'::text, '0111_the_production_session_lifecycle.sql'::text),
    ('20260830113000'::text, 'the_agent_gate_is_a_policy'::text, '0112_the_agent_gate_is_a_policy.sql'::text),
    ('20260830120000'::text, 'the_switch_must_exist_before_it_can_be_off'::text, '0113_the_switch_must_exist_before_it_can_be_off.sql'::text),
    ('20260830130000'::text, 'the_release_takes_its_shape_from_the_feed'::text, '0114_the_release_takes_its_shape_from_the_feed.sql'::text),
    ('20260830140000'::text, 'the_soc_state_belongs_to_the_run'::text, '0115_the_soc_state_belongs_to_the_run.sql'::text),
    ('20260830150000'::text, 'the_reservations_timestamp_dies_with_it'::text, '0116_the_reservations_timestamp_dies_with_it.sql'::text),
    ('20260830160000'::text, 'the_runs_claims_die_with_it'::text, '0117_the_runs_claims_die_with_it.sql'::text),
    ('20260830170000'::text, 'the_clock_of_record_is_the_runs'::text, '0118_the_clock_of_record_is_the_runs.sql'::text),
    ('20260830180000'::text, 'the_coin_had_two_holds'::text, '0119_the_coin_had_two_holds.sql'::text),
    ('20260830190000'::text, 'the_whitelist_kept_a_moving_part'::text, '0120_the_whitelist_kept_a_moving_part.sql'::text),
    ('20260830200000'::text, 'the_odometer_is_dealt_not_inherited'::text, '0121_the_odometer_is_dealt_not_inherited.sql'::text),
    ('20260830210000'::text, 'the_sweep_reads_the_clock_the_stamp_was_written_in'::text, '0122_the_sweep_reads_the_clock_the_stamp_was_written_in.sql'::text),
    ('20260830220000'::text, 'the_latest_need_belongs_to_the_run'::text, '0123_the_latest_need_belongs_to_the_run.sql'::text),
    ('20260830230000'::text, 'the_visit_ledger_belongs_to_the_run'::text, '0124_the_visit_ledger_belongs_to_the_run.sql'::text),
    ('20260830233000'::text, 'the_pair_reads_its_own_boot_state'::text, '0125_the_pair_reads_its_own_boot_state.sql'::text),
    ('20260830234000'::text, 'the_dead_enactor_is_archived'::text, '0126_the_dead_enactor_is_archived.sql'::text),
    ('20260830235000'::text, 'the_teardown_retires_the_interrupted'::text, '0127_the_teardown_retires_the_interrupted.sql'::text),
    ('20260830240000'::text, 'the_adoption_pick_gains_its_content_keys'::text, '0128_the_adoption_pick_gains_its_content_keys.sql'::text),
    ('20260831001500'::text, 'every_pick_orders_itself_completely'::text, '0129_every_pick_orders_itself_completely.sql'::text),
    ('20260831013000'::text, 'the_deferral_queue_orders_itself_completely'::text, '0130_the_deferral_queue_orders_itself_completely.sql'::text),
    ('20260831020000'::text, 'the_matrix_reads_itself_from_the_ledger'::text, '0131_the_matrix_reads_itself_from_the_ledger.sql'::text),
    ('20260831140000'::text, 'the_power_cap_is_a_constraint'::text, '0132_the_power_cap_is_a_constraint.sql'::text),
    ('20260831150000'::text, 'the_energy_path_joins_the_certification'::text, '0133_the_energy_path_joins_the_certification.sql'::text),
    ('20260831190000'::text, 'the_energy_path_reads_only_its_own_run'::text, '0134_the_energy_path_reads_only_its_own_run.sql'::text),
    ('20260831190500'::text, 'the_battery_starts_cold_and_the_fingerprint_sees_it'::text, '0135_the_battery_starts_cold_and_the_fingerprint_sees_it.sql'::text),
    ('20260831200000'::text, 'the_site_limit_is_an_input'::text, '0136_the_site_limit_is_an_input.sql'::text),
    ('20260831221500'::text, 'the_fingerprint_stops_hashing_a_write_timestamp'::text, '0137_the_fingerprint_stops_hashing_a_write_timestamp.sql'::text),
    ('20260901003000'::text, 'the_demand_we_cause_carries_the_run_id'::text, '0138_the_demand_we_cause_carries_the_run_id.sql'::text),
