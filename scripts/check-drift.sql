...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0276_cpsat_enacted_three_times_and_the_scoreboard_called_it_a_stranger'::text, '0276_cpsat_enacted_three_times_and_the_scoreboard_called_it_a_stranger.sql'::text)
