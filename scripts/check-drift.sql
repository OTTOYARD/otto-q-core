...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('PENDING'::text, '0279_the_dial_that_can_kill_a_certification_arm_is_not_in_the_catalog'::text, '0279_the_dial_that_can_kill_a_certification_arm_is_not_in_the_catalog.sql'::text)
