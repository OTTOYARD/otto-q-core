...
-- >>> BEGIN GENERATED MANIFEST — do not edit by hand; run scripts/gen-drift-sql.sh
    ...
    ('20260908161615'::text, 'the_canon_comparison_sees_every_atom_the_pair_enforces'::text, '0225_the_canon_comparison_sees_every_atom_the_pair_enforces.sql'::text),
    ('20260908161239'::text, 'the_recert_floor_reads_a_name_the_ledger_never_writes'::text, '0226_the_recert_floor_reads_a_name_the_ledger_never_writes.sql'::text),
    ('20260908161809'::text, 'the_load_meter_scans_forty_five_thousand_rows_to_sum_three_hundred'::text, '0227_the_load_meter_scans_forty_five_thousand_rows_to_sum_three_hundred.sql'::text),
    ('20260908162004'::text, 'provenance_asks_the_depot_not_the_run_id'::text, '0228_provenance_asks_the_depot_not_the_run_id.sql'::text),
    ...
    ('20260909031507'::text, 'the_proposal_selector_orders_by_a_clock_that_does_not_tick'::text, '0238_the_proposal_selector_orders_by_a_clock_that_does_not_tick.sql'::text),
    ('20260909032347'::text, 'a_certification_that_replays_a_recorded_agent_stream'::text, '0239_a_certification_that_replays_a_recorded_agent_stream.sql'::text),
    ('20260909051802'::text, 'the_gate_that_opens_the_nvidia_door_leaves_a_ledger_row_v2'::text, '0240_the_gate_that_opens_the_nvidia_door_leaves_a_ledger_row.sql'::text),
    ('20260909051917'::text, 'a_certification_hears_only_the_proposers_it_certified'::text, '0241_a_certification_hears_only_the_proposers_it_certified.sql'::text),
    ('20260909052026'::text, 'a_capture_records_only_what_the_run_cannot_regenerate'::text, '0242_a_capture_records_only_what_the_run_cannot_regenerate.sql'::text),
    ...
    ('20260909133254'::text, '0247_a_dead_runs_working_rows_outlive_it_because_nothing_deletes_them'::text, '0247_a_dead_runs_working_rows_outlive_it_because_nothing_deletes_them.sql'::text),
    ...
    ('20260920022145'::text, 'a_stall_reservation_outlives_the_vehicle_that_can_no_longer_use_it'::text, '0360_a_stall_reservation_outlives_the_vehicle_that_can_no_longer_use_it.sql'::text),
    ...
    ('20260921191243'::text, 'the_fault_reroute_gets_the_gate_it_was_missing_and_hears_its_own_gate_say_no_g114'::text, '0400_the_fault_reroute_gets_the_gate_it_was_missing_and_hears_its_own_gate_say_no_g114.sql'::text),
    ('20260921192817'::text, 'the_deploy_dial_gets_one_value_and_the_pointer_gate_gets_switched_on_g114'::text, '0401_the_deploy_dial_gets_one_value_and_the_pointer_gate_gets_switched_on_g114.sql'::text),
    ...
    ('20260922080856'::text, 'i_converted_the_hazard_with_the_metronome_cadence_instead_of_the_sim_time_the_tick_actually_advances'::text, '0420_i_converted_the_hazard_with_the_metronome_cadence_instead_of_the_sim_time_the_tick_actually_advances.sql'::text),
    ...
    ('PENDING'::text, 'the_readiness_gates_hold_clock_lived_on_the_vehicle_so_an_old_runs_stamp_released_fresh_holds'::text, '0446_the_readiness_gates_hold_clock_lived_on_the_vehicle_so_an_old_runs_stamp_released_fresh_holds.sql'::text),
    ('PENDING'::text, 'the_recall_policy_and_the_visit_planner_disagreed_about_maintenance_so_vehicles_looped'::text, '0447_the_recall_policy_and_the_visit_planner_disagreed_about_maintenance_so_vehicles_looped.sql'::text)
